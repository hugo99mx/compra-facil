...
$_LANGMAIL['Newsletter confirmation'] = 'Suscripción al Boletín de noticias';
$_LANGMAIL['Email verification'] = 'Verificación de correo';
$_LANGMAIL['Newsletter voucher'] = 'Boletín de cupón';
...
$_LANGMAIL['Stock coverage'] = 'Alcance del stock';
...
$_LANGMAIL['Process the payment of your order'] = 'Procesar el pago de su pedido';
$_LANGMAIL['Message from contact form\').\' [no_sync]'] = 'Mensaje desde el formulario de contacto\').\'';
...
$_LANGMAIL['Your guest account has been transformed to customer account'] = 'Su cuenta de invitado se cambio a una cuenta de cliente';
$_LANGMAIL['Package in transit'] = 'Paquete en camino';
$_LANGMAIL['Log: You have a new alert from your shop'] = 'Tiene una nueva alerta desde su tienda';
$_LANGMAIL['Your order has been changed'] = 'Su pedido se ha modificado';
$_LANGMAIL['Order confirmation'] = 'Confirmaci';
...
$_LANGMAIL['Your order return state has changed'] = 'El estado de devolución de su pedido ha cambiado';
$_LANGMAIL['Your new password'] = 'Su nueva clave';
$_LANGMAIL['Password query confirmation'] = 'Confirmación de la contraseña de consulta';
...
$_LANGMAIL['New voucher regarding your order %s'] = 'Nuevo vale de descuento con respecto a su orden %s';
